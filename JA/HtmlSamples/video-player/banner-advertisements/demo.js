...
var alternate = true;
        ...
        $(function () {
            ...
            $("#player1").igVideoPlayer({
                ...
                width: 720,
                height: 272,
                posterUrl: 'http://igniteuisamples.ja.staging.infragistics.local/13-2/images/samples/video-player/ig-pres.png',
                fullscreen: false,
                ...
                banners: [{
                    imageUrl: 'http://igniteuisamples.ja.staging.infragistics.local/13-2/images/samples/video-player/banner.png',
