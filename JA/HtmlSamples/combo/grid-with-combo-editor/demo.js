$(function () {
            ...
            $("#gridProducts").igGrid({
                ...
                columns: [
                    ...
                    { headerText: "名前", key: "Name", dataType: "string", width: "190px" },
                    { headerText: "説明", key: "Description", dataType: "string", width: "300px" },
                    { headerText: "カテゴリ", key: "CategoryID", dataType: "number", width: "190px", formatter: formatCategoryCombo }
                ],
                features: [
                    {
                        name: 'Updating',
